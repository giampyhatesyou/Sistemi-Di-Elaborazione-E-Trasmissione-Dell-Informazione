...
/*** TO BE DONE 6.0 START ***/
		if(pthread_create(&thread_ids[i], NULL, &client_connection_thread, connection_no + i) != 0) //client_connection_thread funzione puntatore void?
			fail_errno("Errore creando socket");
/*** TO BE DONE 6.0 END ***/
